...
arrow_list_1 = ["0:1","0:2","0:3","1:4","1:5","1:6","3:7","3:8","3:9",
...
def choice_tree():   
    ...
    for item in box_list_1:
        ...
        if place == "0:0:0":  
            hint = hint_list[2]
            sc.choice()
        elif place == "-1:1:0" or place == "0:1:0" or place ==  "1:1:0":
            hint = hint_list[3]
            sc.choice()
        elif place == "-2:2:0":
            hint = hint_list[4]
            ...
            hint = hint_list[11]
            sc.choice()
        elif place == "0:4:1" or place == "2:4:1":
            hint = hint_list[12]
            sc.choice()
